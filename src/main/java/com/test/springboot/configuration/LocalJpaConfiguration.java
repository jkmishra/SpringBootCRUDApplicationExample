...
@Configuration
@EnableJpaRepositories(basePackages = "com.test.springboot.repositories",
		entityManagerFactoryRef = "entityManagerFactory",
		transactionManagerRef = "transactionManager")
@EnableTransactionManagement
//@Profile("local")
public class LocalJpaConfiguration implements JpaConfiguration{
	...
	public DataSource dataSource() {
		...
		System.out.println("connection with Db server: "+dataSourceProperties.getUrl());
	...
	/* (non-Javadoc)
	 * @see com.test.springboot.configuration.JpaConfiguration#setup()
	 */
	@Override
